...
(function(window, undefined) {
	...
	function isComponentAssociatedinDataList(newInput) {
		hasDatalistParent = newInput.parents(".datalist"),
	...
	jQuery.extend(jimMobile, {
		...
		"loadDate": function() {
			...
			jQuery("#simulation").delegate(".date input:not([readonly])", "click, focusin", function(event, data) {
				...
				if(isComponentAssociatedinDataList(newInput))
					return;
